...
$(function() {
  var bookmark = {
    data: [{
      ...
      box_shadow: '#F18033',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/wyy.jpg',
    }, {
      name: '建工',
      link: 'http://www.jlju.edu.cn/',
      box_shadow: '#11B063',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/jg.jpg',
    }, {
      name: '建工VPN',
      link: 'https://webvpn.jlju.edu.cn/users/sign_in',
      box_shadow: '#FA7199',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/vpn.jpg',
    }, {
      name: '今日热榜',
      link: 'https://tophub.today/',
      box_shadow: '#F2584A',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/headline.png',
    }, {
      name: '知网',
      link: 'https://www.cnki.net/',
      box_shadow: '#F57923',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/zw.jpg',
	}, {
	  name: '疫情跟踪',
	  link: 'https://ncov.dxy.cn/ncovh5/view/pneumonia',
	  box_shadow: '#7C5DC7',
	  icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/ding.png',
    }, {
      name: '有道翻译',
      link: 'http://fanyi.youdao.com/',
      box_shadow: '#2C2C2C',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/yd.jpg',
    }, {
      name: 'github',
      link: 'https://github.com/',
      box_shadow: '#c01d2f',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/g.jpg',
    }, {
      name: '虎牙',
      link: 'https://www.huya.com/',
      box_shadow: '#AC6E2F',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/hy.jpg',
    }, {
      name: 'MSDN',
      link: 'https://msdn.itellyou.cn/',
      box_shadow: '#D7191A',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/msdn.jpg',
    }, {
      name: '软件管家',
      link: 'https://mp.weixin.qq.com/s/zeq1sTmaPsKt7Bsok0Ldrg',
      box_shadow: '#3279ea',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/rjgj.jpg',
    }, {
      name: '吾爱破解',
      link: 'https://www.52pojie.cn/',
      box_shadow: '#62677b',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/wapj.jpg',
    }, {
      name: 'UZER',
      link: 'https://uzer.me/',
      box_shadow: '#c01d2f',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/uzer.jpg',
    }, {
      name: 'bilibili',
      link: 'https://www.bilibili.com/',
      box_shadow: '#fe7700',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/bz.jpg',
    }, {
      name: 'CCTV',
      link: 'http://tv.cctv.com/live/?spm=C28340.P9dhkRStLqPh.EYq0LGFLODJm.2',
      box_shadow: '#AC6E2F',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/cctv.jpg',
    }, {
      name: '京东',
      link: 'https://www.jd.com/',
      box_shadow: '#D7191A',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/jd.jpg',
    }, {
      name: '淘宝',
      link: 'https://www.taobao.com/',
      box_shadow: '#3279ea',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/tb.jpg',
    }, {
      name: '胡萝卜周',
      link: 'http://www.carrotchou.blog/',
      box_shadow: '#00A0E9',
      icon: 'https://cdn.jsdelivr.net/gh/gooddh/cdn@1.1/img/hlbz.jpg',
    }]
  }
...
$('#bg').click(function() {
  width < 768 ? ($('#main').css('background-image') == 'none' ? ($('#main').css('background-image', 'none')) : ($('#main').css('background-image', 'url(img/bg.jpg)'))) : $('#main').css('background-image') == 'none' ? ($('#main').css('background-image', 'url(img/bg.jpg)')) : ($('#main').css('background-image', 'none'));
